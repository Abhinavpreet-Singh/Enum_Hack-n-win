/**
 * Generates a complete Python program that:
 *   1. Buffers all stdin lines up-front (no EOFError)
...
export const generatePythonWrapper = ({
  ...
  // Extract top-level import statements from user code and hoist them
  // to the top so they don't conflict with the stdin reader setup
