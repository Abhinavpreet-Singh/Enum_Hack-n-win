 ...
 * These are the initial code templates shown to the user.
 */
...
export const generateCTemplate = ({ functionName, parameterNames, parameterTypes, returnType }) => {
  ...
  // For array return types, add returnSize output parameter (LeetCode C convention)
...
/**
 * Generate initial code templates for all supported languages.
 */
