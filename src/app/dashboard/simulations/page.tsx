...
interface SimulationItem {
  id: string;
  title: string;
  category: "frontend" | "backend" | "fullstack" | "system-design";
...
export default function SimulationsPage() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((r) => {
        const backend: SimulationItem[] = (r.data.data || []).map(
          (s: SimulationItem) => ({
            ...s,
            // Normalize legacy "devops" → "system-design"
            category:
              s.category === "devops" ? "system-design" : s.category,
          }),
        );
